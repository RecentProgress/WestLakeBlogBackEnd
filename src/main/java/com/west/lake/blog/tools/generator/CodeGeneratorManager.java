...
public class CodeGeneratorManager {
     ...
     * 项目基础路径
     */
    private static final String PROJECT_BASE_PATH = System.getProperty("user.dir") + "/src/main/java/com/west/lake/blog";
    /**
     * 模板文件路径
     */
    private static final String TEMPLATE_FILE_PATH = PROJECT_BASE_PATH + "/tools/generator/template";
    /**
     * Entity生成路径
     */
     ...
     * Controller路径
     */
    private static final String CONTROLLER_PATH = PROJECT_BASE_PATH + "/controller";
    /**
     * Service实现类生成路径
     */
    ...
    public static void main(String[] args) {
        ...
        /*配置类名*/
        dataMap.put("className", "Tag");
        /*配置类描述*/
        dataMap.put("classDesc", "标签");
        /*配置@author*/
