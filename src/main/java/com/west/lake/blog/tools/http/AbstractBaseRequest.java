package com.west.lake.blog.tools.http;
...
public abstract class AbstractBaseRequest {
    ...
    private CloseableHttpClient setConfig() {
        ...
        RequestConfig requestConfig = RequestConfig.custom()
                ...
                .setConnectionRequestTimeout(SystemConfig.RequestConst.CONNECTION_REQUEST_TIMEOUT)
                //the TIME to establish the connection with the remote host
                //与远程主机建立连接的超时时间
                .setConnectTimeout(SystemConfig.RequestConst.CONNECT_TIMEOUT)
                ...
                .setSocketTimeout(SystemConfig.RequestConst.SOCKET_TIMEOUT)
                .build();
    ...
    String sendRequest(RequestMethod method, String url) {
        ...
        try {
            ...
            LOGGER.error(ErrorMessage.LogicErrorMessage.GEN_URI_FAIL + ":" + e.getMessage(), e);
            throw LogicException.le(ErrorMessage.LogicErrorMessage.GEN_URI_FAIL);
        }
        //请求参数
        ...
        switch (method) {
            ...
            //不存在的请求方式
            default:
                throw LogicException.le(ErrorMessage.LogicErrorMessage.REQUEST_METHOD_NOT_EXISTS);
        }
        //判断请求是否成功200
        ...
        if (response != null) {
            try {
                ...
                sb.append(StringUtils.repeat("-", 40)).append("\n")
                        ...
                        .append("【响应结果】:").append(CommonTools.formatJsonString(result)).append("\n")
